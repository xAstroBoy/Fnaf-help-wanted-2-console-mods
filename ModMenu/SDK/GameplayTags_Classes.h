...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_2EVI[0x10];                                  // 0x0038(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_5PA4[0x138];                                 // 0x0028(0x0138) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<class FName, struct FGameplayTagSource>               TagSources;                                              // 0x0160(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_HMM0[0x80];                                  // 0x01B0(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_M65S[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
