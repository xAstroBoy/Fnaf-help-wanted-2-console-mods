...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JRYG[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9JUR[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LNGJ[0x1];                                   // 0x008F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6M2A[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Q73S[0x6];                                   // 0x00AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_8ICZ[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_M03P[0x20];                                  // 0x0030(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_U2LD[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_S2H5[0x28];                                  // 0x0070(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OFDR[0x30];                                  // 0x0208(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MCMA[0x7];                                   // 0x0239(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7WRE[0x20];                                  // 0x0260(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_L3K1[0x20];                                  // 0x02C0(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_JR9T[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailed;                                                // 0x0060(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_POQE[0x30];                                  // 0x0070(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LU70[0x18];                                  // 0x0218(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8P4A[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BB92[0x1F];                                  // 0x00A1(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_STS2[0x10];                                  // 0x00E0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_R4XW[0x64];                                  // 0x030C(0x0064) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H3YQ[0x8];                                   // 0x02C0(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BD0V[0x8];                                   // 0x0580(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_WAU1[0x8];                                   // 0x0238(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VKPG[0x8];                                   // 0x0198(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_77XS[0x3];                                   // 0x01D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_R55G[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZEKU[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VT4S[0x16];                                  // 0x00BA(0x0016) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B7XP[0xC];                                   // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7HW6[0x10];                                  // 0x00E8(0x0010) Fix size for supers
	...
	{
	public:
		unsigned char                                              UnknownData_PV8F[0x4];                                   // 0x00F8(0x0004) Fix Super Size
		...
		unsigned char                                              UnknownData_CV8U[0x4];                                   // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_LKSF[0x8];                                   // 0x00F8(0x0008) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_RWGR[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5Y31[0x3];                                   // 0x0105(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<EARFaceBlendShape, float>                             BlendShapes;                                             // 0x0108(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_628J[0x38];                                  // 0x0158(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_PSPQ[0x4];                                   // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_Y1B1[0x8];                                   // 0x0148(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4HJQ[0x8];                                   // 0x00F8(0x0008) Fix Super Size
	...
	{
	public:
		unsigned char                                              UnknownData_LIUS[0x8];                                   // 0x00F8(0x0008) Fix Super Size
		unsigned char                                              UnknownData_71C2[0x10];                                  // 0x0100(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HUTJ[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
