...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function SWGPlatformUtil.SWGPlatformDLCHandler.MountDLCPackage
	 */
	struct USWGPlatformDLCHandler_MountDLCPackage_Params
	{
	public:
		class FString                                              DLCNameToMount;                                          // 0x0000(0x0010)  (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	};
