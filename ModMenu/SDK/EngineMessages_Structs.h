...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4B3T[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_G3V8[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_NWEI[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
