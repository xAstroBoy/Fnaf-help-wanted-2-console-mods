...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_A5AH[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_W60O[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_FOFR[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_RQHI[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3Z5G[0x7];                                   // 0x0089(0x0007) MISSED OFFSET (PADDING)
	};
