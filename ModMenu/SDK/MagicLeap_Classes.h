...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_WKWJ[0x8];                                   // 0x0120(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_AYYM[0x50];                                  // 0x01A0(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_48TN[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_OWVQ[0x6];                                   // 0x0212(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_43V0[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ACMK[0x3];                                   // 0x0229(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QEOD[0x5];                                   // 0x0233(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_416N[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0TF4[0x14];                                  // 0x027C(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_L3YZ[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ELU9[0x68];                                  // 0x00B0(0x0068) MISSED OFFSET (PADDING)
