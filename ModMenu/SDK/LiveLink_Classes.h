...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3JXE[0x17];                                  // 0x0029(0x0017) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WUVL[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FJ9K[0x10];                                  // 0x0030(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4DZJ[0x1];                                   // 0x0160(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_C6WT[0x6];                                   // 0x0162(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5T48[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_INKE[0x10];                                  // 0x0048(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0EMX[0x28];                                  // 0x0160(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_DZIH[0x10];                                  // 0x00C0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SOME[0x6];                                   // 0x00C2(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GREQ[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OR0E[0xA0];                                  // 0x0028(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IMUV[0x3];                                   // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R1UT[0x6];                                   // 0x00CA(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8S2C[0x3];                                   // 0x0049(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_P5BF[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XPM1[0x64];                                  // 0x005C(0x0064) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_D4QT[0x48];                                  // 0x0038(0x0048) MISSED OFFSET (PADDING)
