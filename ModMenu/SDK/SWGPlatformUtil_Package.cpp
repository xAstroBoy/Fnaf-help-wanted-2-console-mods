...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function SWGPlatformUtil.SWGPlatformDLCHandler.MountDLCPackage
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class FString                                      DLCNameToMount                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void USWGPlatformDLCHandler::MountDLCPackage(const class FString& DLCNameToMount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SWGPlatformUtil.SWGPlatformDLCHandler.MountDLCPackage");
		
		USWGPlatformDLCHandler_MountDLCPackage_Params params {};
		params.DLCNameToMount = DLCNameToMount;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction USWGPlatformDLCHandler.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* USWGPlatformDLCHandler::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class SWGPlatformUtil.SWGPlatformDLCHandler");
		return ptr;
	}
