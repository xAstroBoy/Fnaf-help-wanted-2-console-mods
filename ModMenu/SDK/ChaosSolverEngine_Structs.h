...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_4RFL[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_51H9[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_3IWS[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
