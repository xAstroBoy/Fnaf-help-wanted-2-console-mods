...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_BS_SM_HatAccessory.BP_BS_SM_HatAccessory_C
	 * Size -> 0x0029 (FullSize[0x0249] - InheritedSize[0x0220])
	 */
	class ABP_BS_SM_HatAccessory_C : public AActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_BS_SM_HatAccessory(int32_t EntryPoint);
