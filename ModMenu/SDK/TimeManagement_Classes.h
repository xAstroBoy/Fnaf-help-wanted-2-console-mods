...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_C8RO[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_0XE7[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_21BA[0x27];                                  // 0x0031(0x0027) MISSED OFFSET (PADDING)
