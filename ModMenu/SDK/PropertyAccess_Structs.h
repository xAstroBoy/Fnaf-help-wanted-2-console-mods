...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9T0C[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_M7H9[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_AM1A[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_YHHX[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_5A9E[0x6];                                   // 0x003A(0x0006) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_UZMO[0x18];                                  // 0x00B0(0x0018) MISSED OFFSET (PADDING)
	};
