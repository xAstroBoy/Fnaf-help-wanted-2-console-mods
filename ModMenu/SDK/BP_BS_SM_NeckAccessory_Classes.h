...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_BS_SM_NeckAccessory.BP_BS_SM_NeckAccessory_C
	 * Size -> 0x0029 (FullSize[0x0249] - InheritedSize[0x0220])
	 */
	class ABP_BS_SM_NeckAccessory_C : public AActor
	{
	public:
	...
	public:
		...
		void BndEvt__BP_BS_SM_NeckAccessory_Sphere_K2Node_ComponentBoundEvent_1_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit);
		void ExecuteUbergraph_BP_BS_SM_NeckAccessory(int32_t EntryPoint);
