...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_BS_SM_EyesAccessory_MapBot.BP_BS_SM_EyesAccessory_MapBot_C
	 * Size -> 0x0018 (FullSize[0x0261] - InheritedSize[0x0249])
	 */
	class ABP_BS_SM_EyesAccessory_MapBot_C : public ABP_BS_SM_EyesAccessory_C
	{
	public:
		unsigned char                                              UnknownData_8WDP[0x7];                                   // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_BS_SM_EyesAccessory_MapBot(int32_t EntryPoint);
