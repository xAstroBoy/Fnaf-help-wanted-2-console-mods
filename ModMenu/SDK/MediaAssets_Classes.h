...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_TD1T[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3ABU[0x17];                                  // 0x0099(0x0017) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1G83[0x2];                                   // 0x00C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5259[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DIM0[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6XGY[0x2C];                                  // 0x00F4(0x002C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LT5I[0x8];                                   // 0x0130(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LJ06[0x3];                                   // 0x06C1(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_QC5F[0x3];                                   // 0x06C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7IV5[0x4];                                   // 0x06DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0UOQ[0x138];                                 // 0x06E8(0x0138) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GS2M[0x3];                                   // 0x0195(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1UHT[0xC0];                                  // 0x01A0(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JAJ5[0x3];                                   // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
