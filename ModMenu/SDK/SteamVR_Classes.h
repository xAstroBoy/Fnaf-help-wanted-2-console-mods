...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_SBCO[0x8];                                   // 0x00D0(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VNER[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_95SX[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
