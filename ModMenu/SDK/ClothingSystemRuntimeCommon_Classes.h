...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3Y72[0x4];                                   // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_1N2B[0x20];                                  // 0x0168(0x0020) MISSED OFFSET (PADDING)
