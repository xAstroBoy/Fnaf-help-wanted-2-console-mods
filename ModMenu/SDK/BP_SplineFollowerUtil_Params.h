...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_SplineFollowerUtil.BP_SplineFollowerUtil_C.SplineDirectionToMult
	 */
	struct UBP_SplineFollowerUtil_C_SplineDirectionToMult_Params
	{
	public:
		...
		unsigned char                                              UnknownData_HS69[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
