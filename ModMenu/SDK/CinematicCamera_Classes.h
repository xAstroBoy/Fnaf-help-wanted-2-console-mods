...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UO02[0x2];                                   // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_3QEK[0x3];                                   // 0x0225(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_XGL5[0x10];                                  // 0x0800(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KJ23[0xC];                                   // 0x0864(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y9B0[0x8];                                   // 0x08C8(0x0008) MISSED OFFSET (PADDING)
