...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_BS_SM_EyesAccessory.BP_BS_SM_EyesAccessory_C
	 * Size -> 0x0029 (FullSize[0x0249] - InheritedSize[0x0220])
	 */
	class ABP_BS_SM_EyesAccessory_C : public AActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_BS_SM_EyesAccessory(int32_t EntryPoint);
