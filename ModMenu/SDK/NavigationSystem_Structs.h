...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_WJLM[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_VL04[0x10];                                  // 0x0008(0x0010) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_H95Y[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_908W[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_MXY9[0x18];                                  // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_FFOG[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_AUKE[0x2];                                   // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZD5A[0x3];                                   // 0x003D(0x0003) MISSED OFFSET (PADDING)
	};
