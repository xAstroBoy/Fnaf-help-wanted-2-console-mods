...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LI6Z[0x3];                                   // 0x021D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9JOR[0x4];                                   // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4BVO[0x18];                                  // 0x0248(0x0018) MISSED OFFSET (PADDING)
