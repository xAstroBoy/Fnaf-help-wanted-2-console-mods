...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_RM_NeckAccessory.BP_RM_NeckAccessory_C
	 * Size -> 0x0042 (FullSize[0x0262] - InheritedSize[0x0220])
	 */
	class ABP_RM_NeckAccessory_C : public AActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_RM_NeckAccessory(int32_t EntryPoint);
